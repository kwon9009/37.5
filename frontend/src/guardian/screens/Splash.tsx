  ...
  return (
    <Screen className="bg-primary text-primary-foreground">
      ...
      <div className="px-6 pb-10">
        <Button variant="outline" className="border-transparent font-bold text-primary-foreground/80" onClick={() => navigate("/guardian/terms")}>
          시작하기
        </Button>
        <button
          className="mt-3 w-full text-center text-sm font-medium text-primary-foreground/80 hover:text-primary-foreground"
